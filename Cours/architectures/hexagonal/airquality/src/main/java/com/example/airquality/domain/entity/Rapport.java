package com.example.airquality.domain.entity;
...
public class Rapport {
    ...
    public Rapport(Long id, double latitude, double longitude, LocalDateTime dateHeure, String niveauPollution, String commentaires) {
        this.id = id;
